...
class Level:
    def __init__(self, grass_patch_model, grass_plane_model, fence_model, skybox_model, plane_scale=2, grass_scale=1,
                 grass_amount=20):
        ...
        self.createSkybox(skybox_model)
    ...
    def createSkybox(self, skybox_model, skybox_texture):
        self.skybox = ObjectCube(Vector(10, 0.3, 10), Vector(0, 0, 0), Vector(0.5, 0.5, 0.5), skybox_model,
                                 diffuse_texture_id=skybox_texture)
